...
QT_MOC_LITERAL(1, 12, 10), // "transmitdb"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "QSqlDatabase"
QT_MOC_LITERAL(4, 37, 2), // "db"
QT_MOC_LITERAL(5, 40, 19), // "on_loginBtn_clicked"
QT_MOC_LITERAL(6, 60, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(7, 82, 23) // "on_pushButton_2_clicked"

    },
    "LoginDialog\0transmitdb\0\0QSqlDatabase\0"
    "db\0on_loginBtn_clicked\0on_pushButton_clicked\0"
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transmitdb((*reinterpret_cast< QSqlDatabase(*)>(_a[1]))); break;
        ...
        {
            typedef void (LoginDialog::*_t)(QSqlDatabase );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginDialog::transmitdb)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::transmitdb(QSqlDatabase _t1)
{
