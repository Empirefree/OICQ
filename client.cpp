    ...
    ui(new Ui::Client)
{
    ...
    connect(tClnt, SIGNAL(error(QAbstractSocket::SocketError)), this, SLOT(displayErr(QAbstractSocket::SocketError)));  //文件传输过程中出错的处理

}

void Client::displayErr(QAbstractSocket::SocketError sockaddr){
    switch (sockaddr) {
